        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //Emails
             $email_notification_create_paylist = (new TemplatedEmail())
                ...
                ->context([
                    'merchant_name' => $form->get('merchantName')->getData(),
                    'list_name' => $form->get('listName')->getData(),
                    'execution_date' => $form->get('executionDate')->getData(),
                    'total'=> $form->get('totalParticipants')->getData(),
                    'success' => $form->get('totalParticipants')->getData() - count($form->get('failReasons')->getData()),
                    'failed' => count($form->get('failReasons')->getData()),
                    'numbers' => $form->get('failReasons')->getData(),
                ]);
